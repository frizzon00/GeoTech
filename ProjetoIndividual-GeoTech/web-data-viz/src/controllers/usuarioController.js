...
function sugestoes(req, res) {
    usuarioModel.sugestoes()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json({ mensagem: resultado[0].qtdMensagens });
            } else {
...
function elogios(req, res) {
    usuarioModel.elogios()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json({ mensagem: resultado[0].qtdMensagens });
            } else {
...
function memoryGame1(req, res) {
    usuarioModel.memoryGame1()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json({ jogo: resultado[0].qtdTentativas });
            } else {
                res.status(204).send("Nenhum resultado encontrado!");
            }
        })
...
function memoryGame2(req, res) {
    usuarioModel.memoryGame2()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json({ jogo: resultado[0].qtdTentativas });
            } else {
...
function bandeira1(req, res) {
    usuarioModel.bandeira1()
        .then(function (resultado) {
            if (resultado.length > 0) {
                res.status(200).json({ jogo: resultado[0].qtdTentativas });
            } else {
...
function conexao(req, res) {
    ...
    // Passe os valores como parâmetro e vá para o arquivo usuarioModel.js
    usuarioModel.conexao(idUsuario)
        .then(
            function (resultado) {
                res.json(resultado);
            }
